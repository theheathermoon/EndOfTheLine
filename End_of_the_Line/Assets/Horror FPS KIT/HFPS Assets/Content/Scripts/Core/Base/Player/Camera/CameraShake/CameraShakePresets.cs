...
namespace HFPS.Player
{
    ...
    {
        /// <summary>
        /// [One-Shot] A smooth scare shake.
        /// </summary>
        public static CameraShakeInstance Scare
        {
            get
            {
                CameraShakeInstance c = new CameraShakeInstance(3f, 3f, 0.1f, 2f);
                c.PositionInfluence = new Vector3(0.15f, 0.15f, 0f);
