	...
	SubShader
	{
		...
		#define UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input)
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float localApplyAuraLighting16_g20 = ( 0.0 );
				float4 temp_output_13_0_g20 = Color7;
				float3 Color16_g20 = (temp_output_13_0_g20).rgb;
				float4 screenPos = i.ase_texcoord1;
				float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( screenPos );
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float eyeDepth = i.ase_texcoord.z;
				float Depth1_g21 = eyeDepth;
				float localRescaleDepth1_g21 = RescaleDepth( Depth1_g21 );
				float3 appendResult2_g21 = (float3(ase_grabScreenPosNorm.r , ase_grabScreenPosNorm.g , localRescaleDepth1_g21));
				float3 temp_output_25_0_g20 = appendResult2_g21;
				float3 BufferCoordinates16_g20 = temp_output_25_0_g20;
				float LightingFactor16_g20 = _IlluminationStrength;
				float3 LightingValue16_g20 = tex3D( Aura_VolumetricDataTexture, temp_output_25_0_g20 ).rgb;
				Aura2_ApplyLighting(Color16_g20, BufferCoordinates16_g20, LightingFactor16_g20, LightingValue16_g20);
				float4 appendResult23_g20 = (float4(Color16_g20 , (temp_output_13_0_g20).a));
				#ifdef _USEILLUMINATION_ON
				float4 staticSwitch4 = appendResult23_g20;
				#else
...
WireConnection;31;13;8;0
WireConnection;31;22;5;0
WireConnection;4;1;9;0
WireConnection;4;0;31;17
WireConnection;14;0;4;0
WireConnection;29;3;15;0
