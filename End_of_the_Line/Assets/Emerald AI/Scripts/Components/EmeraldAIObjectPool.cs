    ...
    public static class EmeraldAIObjectPool
    {
        ...
        class Pool
        {
            ...
            public GameObject SpawnEffect(Vector3 pos, Quaternion rot, float SecondsToDespawn)
            {
                ...
                if (obj.GetComponent<EmeraldAITimedDespawn>() == null)
                {
                    obj.AddComponent<EmeraldAITimedDespawn>().SecondsToDespawn = SecondsToDespawn;
                }
                else
                {
                    obj.GetComponent<EmeraldAITimedDespawn>().SecondsToDespawn = SecondsToDespawn;
                }
